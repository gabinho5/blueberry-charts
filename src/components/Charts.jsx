  ...
  render() {
    return(
      <ResponsiveContainer height='100%' width='100%'>
        <BarChart style = {styles.size} data={this.props.isProjectView ? this.props.filteredobject.title : this.props.filteredobject.name}
          margin={{top: 60, right: 60, left: 60, bottom: 130}}>
          <XAxis interval={0} angle={-45} textAnchor='end' dataKey={this.props.isProjectView ? 'title' : 'name'} style={{fontSize: 12}}/>
          <YAxis/>
